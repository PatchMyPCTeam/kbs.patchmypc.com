...
- [Video Guide for Microsoft Intune Setup](#video-guide-for-microsoft-intune-setup)
- [Request a 30-Day Intune Trial](#request-30-day-intune-trial)
- [Set Up a Custom Domain Name (Optional)](#setup-custom-domain-name)
- [Enable Automatic Enrollment for Windows Devices and Enterprise Mobility + Security E5 90-Day Free Trial](#automatic-enrollment)
- [Create User for Intune Enrollment via Windows Autopilot](#create-user)
- [Enable Company Branding in Azure Active Directory (Optional)](#company-branding)
- [Disable Windows Hello for Business](#disable-hellow)
- [Enroll a Windows 11 Device Into Microsoft Intune Using Windows Autopilot](#enroll-device)
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/udWdvVSzeTg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen data-cookieconsent="ignore"></iframe>
...
![Microsoft Intune Trial - Let's get you started](images/Microsoft-Intune-Trial-Lets-get-you-started.png)
...
![Intune Set up account](images/Intune-Set-up-account.png)
...
![Create a new account instead](images/Create-a-new-account-instead.png)

Complete the **Tell us about yourself** form and click **Next**

**![tell us about yourself](images/tell-us-about-yourself.png)**
...
![Complete verification process for Intune](images/Complete-verification-process-for-Intune.png)

On the **How you'll sign in** form, you will need to enter the **tenant's username**, **Domain name,** and **password** and click **Next**.

![How you'll sign in form](images/How-youll-sign-in-form.png)

You will be redirected to the **Confirmation details** screen, which shows details about the Intune tenant.

![Intune Trial Setup confirmation page](images/Intune-Trial-Setup-confirmation-page.png)
...
[![More Information](images/more-info-icon.svg)](https://patchmypc.com/app/uploads/2025/05/more-info-icon.svg)Note: Using a custom domain is optional. If you don't use a custom domain, you can log in using the username@setupmem.onmicrosoft.com domain for example rather than username@setupmem.com.
...
![Cloudflare Register Domains Navigation](images/Cloudflare-Register-Domains-Navigation.png)

Search for your **desired domain name** and click **Purchase**. Complete the prompts to purchase the domain.

![Purchase domain in Cloudflare](images/Purchase-domain-in-Cloudflare.png)
...
![Add a custom domain Microsoft 365 admin center](images/Add-a-custom-domain-Microsoft-365-admin-center.png)

_You can find more about adding a custom domain name at [Add a domain to Microsoft 365 - Microsoft 365 admin](https://learn.microsoft.com/en-us/microsoft-365/admin/setup/add-domain?view=o365-worldwide)._
...
![Authorize DNS records from Microsoft using Microsoft domain connect](images/Authorize-DNS-records-from-Microsoft-using-Microsoft-domain-connect.png)

Click **Done** on the **Domain setup is complete** dialog.

![Domain setup is complete step](images/Domain-setup-is-complete-step.png)
...
![Activate 90 day Trial of Enterprise Mobility and Security E5](images/Activate-90-day-Trial-of-Enterprise-Mobility-and-Security-E5.png)

[![More Information](images/more-info-icon.svg)](https://patchmypc.com/app/uploads/2025/05/more-info-icon.svg)Note: The trial may take a few minutes to activate. Once activated, you can enable Automatic enrollment for Windows devices. The Enterprise Mobility + Security E5 includes the Microsoft Intune license.
...
![Assign license to user in Licenses page in Microsoft 365 admin center](images/Assign-license-to-user-in-Licenses-page-in-Microsoft-365-admin-center.png)
...
![Enable All for MDM user scope and MEM user scope for automatic enrollment for Windows](images/Enable-All-for-MDM-user-scope-and-MEM-user-scope-for-automatic-enrollment-for-Windows.png)
...
![create new user microsoft 365 admin center](images/create-new-user-microsoft-365-admin-center.png)
...
![Assign product license for Enterprise Mobility and Security E5](images/Assign-product-license-for-Enterprise-Mobility-and-Security-E5.png)
...
![user added to active users in microsoft admin center](images/user-added-to-active-users-in-microsoft-admin-center.png)
...
![Add Company branding in Azure Active Directory Properties](images/Add-Company-branding-in-Azure-Active-Directory-Properties.png)

[![More Information](images/more-info-icon.svg)](https://patchmypc.com/app/uploads/2025/05/more-info-icon.svg)Tip: Want more Patch My PC themed content? Download a variety of wallpapers at **[Patch My PC Logos, Wallpapers, and Brand Resources](https://patchmypc.com/patch-my-pc-logos-wallpapers-and-brand-resources)**
...
![Disable Windows Hello for Business in Microsoft Intune Windows enrollment](images/Disable-Windows-Hello-for-Business-in-Microsoft-Intune-Windows-enrollment.png)

[![More Information](images/more-info-icon.svg)](https://patchmypc.com/app/uploads/2025/05/more-info-icon.svg)**Note:** You probably wouldn't want to disable Windows Hello for Business in a **production environment**.
...
**![Let's set things up for your work or school](images/Lets-set-things-up-for-your-work-or-school.png)**

After clicking Next, we can see the **custom Company branding** is now available. Enter the **password** and click **Sign in**.

![Enter password for account in autopilot during OOBE](images/Enter-password-for-account-in-autopilot-during-OOBE.png)
...
![Open access work or school in Windows 11 settings](images/Open-access-work-or-school-in-Windows-11-settings.png)

Click the **Info** button for your user's account in the **Access work or school**.

![Click info in access work or school](images/Click-info-in-access-work-or-school.png)
...
![Sync device to Microsoft Intune under Access work or school](images/Sync-device-to-Microsoft-Intune-under-Access-work-or-school.png)

The **device should appear in the Microsoft Endpoint Manager console in a few minutes**!

![Device enrolled into Microsoft Intune](images/Device-enrolled-into-Microsoft-Intune.png)
