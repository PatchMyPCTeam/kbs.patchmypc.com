...
![App Registration Permissions](../../_images/IntuneAppRegPerms.png)
...
![GroupMember.Read.All Permission Selected](../../_images/GroupMemberReadAll.png)
...
![the application client id in azure ad](../../_images/application-client-id.png)
