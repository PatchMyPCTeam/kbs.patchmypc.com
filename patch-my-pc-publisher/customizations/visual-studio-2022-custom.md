...
| Visual Studio 2022 Community | [https://aka.ms/vs/17/release/vs\_community.exe](https://aka.ms/vs/17/release/vs_community.exe "https://aka.ms/vs/17/release/vs_community.exe") |
...
3. Save it to a location where you have write permissions.
...
3. Navigate to the directory where you saved the stub installer.

5. Run the following command to create a minimal local layout:
...
3. Compress the following files and folders into a ZIP archive:
...
5. Delete the original files and folders from `.localVSlayout` after confirming the ZIP file was created successfully.
...
17. The app is now ready to be published.
