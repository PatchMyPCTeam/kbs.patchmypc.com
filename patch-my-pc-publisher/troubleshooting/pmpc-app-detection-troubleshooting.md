...
- [Local Copy of PowerShell Scripts](#topic1)
- [Troubleshooting ConfigMgr Scripts](#topic2)
- [Topic3](#topic3)
- [Topic4](#topic4)
- [Topic5](#topic5)
- [Topic6](#topic6)
...
- [Get a Copy of Detection Script](#ConfigMgrCopyScript)
- [Validate Code Signing Certificate Trust If Applicable](#ConfigMgrCodeSigning)
    - [Check Client Settings Execution Policy](#ConfigMgrExecutionPolicy)
- [Run Script On Client](#ConfigMgrRunScript) 
- [Run Script On Client In Verbose Mode](#ConfigMgrRunScriptVerbose)
- [Evaluate Patch My PC Log File](#PMPCLog)
- [Evaluate Configuration Manager Log Files](#ConfigMgrLogs)
- [Collect Uninstall Registry Hives for Support](#CollectUninstallHive)

## Get a Copy of Detection Script

Reference the [beginning of this article](#Topic1) to find the location of your Configuration Manager application detection scripts. 
...
If the scripts are being signed, then you'll need to verify the trust relationship. If they are **not signed**, you'll still want to [verify the execution policy configured in your Client Settings](#ConfigMgrExecutionPolicy).
...
![Export-PMPCUninstallRegistryhives](/_images/Export-PMPCUninstallRegistryhives-Example.png "Export-PMPCUninstallRegistryhives")
