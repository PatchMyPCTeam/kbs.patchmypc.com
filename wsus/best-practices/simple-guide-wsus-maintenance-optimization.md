...
![WSUS Sync From the Windows Update Catalog From the Internet](../../_images/WSUS-Sync-From-the-Windows-Update-Catalog-From-the-Internet-Sync.png)
...
![Synchronize Software Updates](../../_images/Synchronize-Software-Updates.png)
...
![wsyncmgr sync from WSUS to ConfigMgr SUP](../../_images/wsyncmgr-sync-from-WSUS-to-ConfigMgr-SUP.png)
...
![Microsoft.UpdateServices.Internal.DatabaseAccess.ApiRemotingCompressionProxy.GetWebResponse](../../_images/Microsoft-UpdateServices-Internal-DatabaseAccess-ApiRemotingCompressionProxy-GetWebResponse.png)
...
![exec spSearchUpdates in SQL Management Studio for WSUS Performance Check](../../_images/RemoteDesktopManagerFree_232HaqhWGO.gif)
...
![Software Update Point in Configure Site Components ConfigMgr](../../_images/Software-Update-Point-in-Configure-Site-Components-ConfigMgr.png)
...
![wsyncmgr cleanup in wsyncmgr.log](../../_images/wsyncmgr-cleanup-in-wsyncmgr-log_.png)
...
![Validate non-clustered indexes exist on SUSDB](../../_images/RemoteDesktopManagerFree_jPhbBSFWsp.gif)
...
![WsusPool Advanced Settings...](../../_images/WsusPool-Advanced-Settings.png)
...
![Disable recycling and configure memory limits](../../_images/WSUS-App-Pool-Best-Practice-Settings.png)

Click **OK** to save the settings then **right-click the WsusPool** and click **Recycle...**

![Recycle WsusPool in IIS](../../_images/Recycle-WsusPool-in-IIS.png)
...
![Uncheck Unneeded Products ConfigMgr SUP](../../_images/Uncheck-Unneeded-Products-ConfigMgr-SUP.png)
...
![New Query SUSDB in SQL Management Studio](../../_images/New-Query-SUSDB-in-SQL-Management-Studio.png)
...
![Reindex the WSUS database (SUSDB)](../../_images/Reindex-the-WSUS-database-SUSDB.png)
...
![Create SQL Indexes for SUSDB for WSUS Performance](../../_images/Create-SQL-Indexes-for-SUSDB-for-WSUS-Performance.png)
