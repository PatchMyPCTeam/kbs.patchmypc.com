...
![WSUS Sync From the Windows Update Catalog From the Internet](images/WSUS-Sync-From-the-Windows-Update-Catalog-From-the-Internet-Sync.png)
...
![Synchronize Software Updates](images/Synchronize-Software-Updates.png)
...
![wsyncmgr sync from WSUS to ConfigMgr SUP](images/wsyncmgr-sync-from-WSUS-to-ConfigMgr-SUP.png)
...
![Microsoft.UpdateServices.Internal.DatabaseAccess.ApiRemotingCompressionProxy.GetWebResponse](images/Microsoft.UpdateServices.Internal.DatabaseAccess.ApiRemotingCompressionProxy.GetWebResponse.png)
...
![exec spSearchUpdates in SQL Management Studio for WSUS Performance Check](images/RemoteDesktopManagerFree_232HaqhWGO.gif)
...
![Software Update Point in Configure Site Components ConfigMgr](images/Software-Update-Point-in-Configure-Site-Components-ConfigMgr.png)
...
![Decline expired updates in WSUS according to supersedence rules and Add non-clustered indexes to the WSUS database and Add non-clustered indexes to the WSUS database](images/Decline-expired-updates-in-WSUS-according-to-supersedence-rules-and-Add-non-clustered-indexes-to-the-WSUS-database-and-Add-non-clustered-indexes-to-the-WSUS-database.png)
...
![wsyncmgr cleanup in wsyncmgr.log](images/wsyncmgr-cleanup-in-wsyncmgr.log_.png)
...
![Validate non-clustered indexes exist on SUSDB](images/RemoteDesktopManagerFree_jPhbBSFWsp.gif)
...
![WsusPool Advanced Settings...](images/WsusPool-Advanced-Settings.png)
...
![Disable recycling and configure memory limits](images/WSUS-App-Pool-Best-Practice-Settings.png)

Click **OK** to save the settings then **right-click the WsusPool** and click **Recycle...**

![Recycle WsusPool in IIS](images/Recycle-WsusPool-in-IIS.png)
...
![Uncheck Unneeded Products ConfigMgr SUP](images/Uncheck-Unneeded-Products-ConfigMgr-SUP.png)
...
![New Query SUSDB in SQL Management Studio](images/New-Query-SUSDB-in-SQL-Management-Studio.png)
...
![Reindex the WSUS database (SUSDB)](images/Reindex-the-WSUS-database-SUSDB.png)
...
![Create SQL Indexes for SUSDB for WSUS Performance](images/Create-SQL-Indexes-for-SUSDB-for-WSUS-Performance.png)
